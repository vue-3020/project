...
export default {
  ...
  created() {
    ...
    axios.get('https://www.easy-mock.com/mock/5bbab3f329a4d80bbccbcb81/example/kfc2')
      .then(response => {
    ...
    //读取分类商品列表
    axios.get('https://www.easy-mock.com/mock/5bbab3f329a4d80bbccbcb81/example/kfc')
      .then(response => {
